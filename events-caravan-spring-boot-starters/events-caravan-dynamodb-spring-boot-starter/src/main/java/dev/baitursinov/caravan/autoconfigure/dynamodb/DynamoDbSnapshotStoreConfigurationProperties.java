 ...
 */
@ConfigurationProperties(DynamoDbSnapshotStoreConfigurationProperties.PREFIX)
public record DynamoDbSnapshotStoreConfigurationProperties(String tableName,
