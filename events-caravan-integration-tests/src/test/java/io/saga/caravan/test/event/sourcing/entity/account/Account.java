...
import io.saga.caravan.event.sourcing.applying.EventApplier;
import io.saga.caravan.test.event.sourcing.entity.calculator.NumberCarryingPayload;
import lombok.AccessLevel;
import lombok.Getter;
import lombok.RequiredArgsConstructor;

import static io.saga.caravan.test.event.sourcing.entity.account.AccountEventsConfiguration.ACCOUNT;
