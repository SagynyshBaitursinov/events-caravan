...
import dev.baitursinov.caravan.event.EventReference;
...
import static dev.baitursinov.caravan.event.sourcing.dynamodb.PrimaryKeyUtils.toShardedPartitionKeyValue;
