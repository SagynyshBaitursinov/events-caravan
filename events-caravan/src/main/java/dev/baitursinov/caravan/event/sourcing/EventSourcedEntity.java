...
import dev.baitursinov.caravan.entity.Entity;
 ...
 * {@link dev.baitursinov.caravan.event.sourcing.applying.ApplyEvent} are utilized.
 *
...
public abstract class EventSourcedEntity extends Entity {
   ...
   * applying it via the matching {@link dev.baitursinov.caravan.event.sourcing.applying.ApplyEvent}
